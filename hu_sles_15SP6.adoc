...
.開始する前に
ご使用の構成でSANブートがサポートされているlink:https://imt.netapp.com/matrix/#welcome["Interoperability Matrix Tool"^]OS、HBA、HBAファームウェア、HBAブートBIOS、およびONTAPバージョンがサポートされていることを確認するには、を参照してください。
