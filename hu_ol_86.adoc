...
NOTE: Oracle Linux 8.6 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）8.6を使用しますlink:hu_rhel_86.html#recommended-settings["推奨設定"]。
