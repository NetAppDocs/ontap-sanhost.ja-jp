...
NOTE: Oracle Linux 8.6 Red Hat Enterprise Kernel（RHCK）を設定するには、link:hu_rhel_86.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）8.6を使用します。
...
ONTAPリリースのOracle Linux 8.6に関する既知の問題はありません。
