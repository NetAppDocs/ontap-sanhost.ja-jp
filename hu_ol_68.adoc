...
NOTE: Oracle Linux 6.8 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）6.8を使用しlink:hu_rhel_68.html#recommended-settings["推奨設定"]ます。
...
NOTE: Oracle Linux RHCKの既知の問題については、（RHEL 6.8）を参照してくださいlink:hu_rhel_68.html#known-problems-and-limitations["既知の問題"]。
