...
---
= NetApp ONTAP で Oracle Linux 6.8 を使用する
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Oracle Linux 6.8 RedHat Enterprise Kernel (RHCCK) を設定するには、を使用します link:hu_rhel_68.html#recommended-settings["推奨設定"] Red Hat Enterprise Linux （ RHEL ） 6.8 の場合。



== 既知の問題および制限

Oracle 6.8 には既知の問題はありません。
