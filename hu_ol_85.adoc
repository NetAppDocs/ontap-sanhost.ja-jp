...
NOTE: Oracle Linux 8.5 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）8.5を使用しlink:hu_rhel_85.html#recommended-settings["推奨設定"]ます。
...
NOTE: Oracle Linux RHCKの既知の問題については、対応するRHELリリースドキュメントのセクションを参照してくださいlink:hu_rhel_85.html#known-problems-and-limitations["既知の問題"]。
