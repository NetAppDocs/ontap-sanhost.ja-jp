...
summary: ONTAPストレージを搭載した Rocky Linux 10.0 用の NVMe-oF ホストを構成する方法 
---
...
Rocky Linux 10.0 用に NVMe over Fabrics (NVMe-oF) ホストを構成する方法を学びます。詳細なサポートと機能情報については、 link:nvme-rockylinux-supported-features.html["Rocky Linux ONTAPのサポートと機能"]。
