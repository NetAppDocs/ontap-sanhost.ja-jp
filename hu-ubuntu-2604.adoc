...
summary: Ubuntu 26.04 ホストに Linux Host Utilities をインストールして、ONTAP LUN との FCP および iSCSI プロトコル操作を管理します。 
---
= Ubuntu 26.04 を ONTAP ストレージの FCP および iSCSI 用に構成する
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Linux Host Utilities ソフトウェアは、ONTAP ストレージに接続されている Linux ホストの管理および診断ツールを提供します。Ubuntu 26.04 ホストに Linux Host Utilities をインストールすると、Host Utilities を使用して ONTAP LUN との FCP および iSCSI プロトコル操作を管理できます。
...
Ubuntu 26.04 でマルチパスを使用して ONTAP LUN を管理できます。
