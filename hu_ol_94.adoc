...
NOTE: Oracle Linux 9.4 Red Hat Enterprise Kernel（RHEK）を設定するには、for Red Hat Enterprise Linux（RHEL）9.4を使用しlink:hu_rhel_94.html#recommended-settings["推奨設定"]ます。
