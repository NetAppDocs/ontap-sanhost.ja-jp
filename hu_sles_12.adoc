...
summary: SUSE Linux Enterprise Server 12にLinux Host Utilitiesをインストールして、ONTAP LUNでFCPおよびiSCSIプロトコルの処理を管理します。 
---
...
.手順
. SANブートLUNを作成してホストにマッピングします。
+
を参照してください https://docs.netapp.com/us-en/ontap/san-admin/provision-storage.html["SANストレージのプロビジョニング"^]
