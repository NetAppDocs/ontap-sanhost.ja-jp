...
NOTE: Oracle Linux 7.2 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）7.2を使用しlink:hu_rhel_72.html#recommended-settings["推奨設定"]ます。



== 既知の問題

ONTAPリリースのOracle Linux 7.2では、既知の問題はありません。
