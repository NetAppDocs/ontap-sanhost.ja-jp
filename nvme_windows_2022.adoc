...
summary: Windows Server 2022 with ONTAP のNVMe/FCホスト構成 
---
= Windows Server 2022 with ONTAP のNVMe/FCホスト構成
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
ONTAPをターゲットとして使用して、Windows Server 2022を実行しているホストにNVMe over Fibre Channel（NVMe/FC）を設定できます。

NVMe/FCはWindows Server 2022のONTAP 9.7以降でサポートされます。
