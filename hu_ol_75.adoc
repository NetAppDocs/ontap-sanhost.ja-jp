...
NOTE: Oracle Linux 7.5 Red Hat Enterprise Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）7.5を使用しlink:hu_rhel_75.html#recommended-settings["推奨設定"]ます。
