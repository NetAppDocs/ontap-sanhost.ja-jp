...
NOTE: Oracle Linux 7.5 Red Hat Enterprise Kernel（RHCK）を設定するには、link:hu_rhel_75.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）7.5を使用します。
