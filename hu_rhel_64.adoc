...
[role="lead"]
ONTAP SANホストの設定を使用して、ONTAPをターゲットとしてRed Hat Enterprise Linux 6.4を設定できます。
...
RHEL 6.4 with ONTAPリリースには、次の既知の問題があります。
