...
NOTE: Oracle Linux 7.0 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）7.0を使用しlink:hu_rhel_70.html#recommended-settings["推奨設定"]ます。
