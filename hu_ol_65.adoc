...
NOTE: Oracle Linux 6.5 Red Hat Enterprise Kernel（RHCK）を設定するには、link:hu_rhel_65.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）6.5を使用します。
