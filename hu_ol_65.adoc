...
NOTE: Oracle Linux 6.5 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）6.5を使用しlink:hu_rhel_65.html#recommended-settings["推奨設定"]ます。
...
NOTE: Oracle Linux RHCKの既知の問題については、（RHEL 6.5）を参照してくださいlink:hu_rhel_65.html#known-problems-and-limitations["既知の問題"]。
