...
NOTE: Oracle Linux 8.10 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）8.10を使用しますlink:hu_rhel_810.html#recommended-settings["推奨設定"]。
