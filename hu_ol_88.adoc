...
NOTE: Oracle Linux 8.8 Red Hat Enterprise Kernelを設定するには、link:hu_rhel_88.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）8.8を使用します。
...
ONTAPリリースのOracle Linux 8.8に関する既知の問題はありません。
