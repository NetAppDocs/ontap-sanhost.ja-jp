...
summary: Ubuntu 22.04 をマルチパス用に構成し、 ONTAPストレージを使用した FCP および iSCSI 操作用の特定のパラメータと設定を設定します。 
---
...
[role="lead"]
Ubuntu 24.04 をマルチパス用に構成し、 ONTAPストレージを使用した FCP および iSCSI 操作用の特定のパラメータと設定を設定します。
