...
NOTE: Oracle Linux 8.9 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）8.9を使用しますlink:hu_rhel_89.html#recommended-settings["推奨設定"]。
