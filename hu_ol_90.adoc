...
NOTE: Oracle Linux 9.0 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）9.0を使用しlink:hu_rhel_86.html#recommended-settings["推奨設定"]ます。
