...
[role="lead"]
ONTAP SANホストの設定を使用して、ONTAPをターゲットとしてOracle Linux 9.0を設定できます。
...
NOTE: Oracle Linux 9.0 Red Hat Enterprise Kernel（RHCK）を設定するには、link:hu_rhel_86.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）9.0を使用します。
