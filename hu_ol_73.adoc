...
NOTE: Oracle Linux 7.3 Red Hat Enterprise Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）7.3を使用しlink:hu_rhel_73.html#recommended-settings["推奨設定"]ます。
