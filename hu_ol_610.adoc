...
NOTE: Oracle Linux 6.10 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）6.10を使用しますlink:hu_rhel_610.html#recommended-settings["推奨設定"]。
...
NOTE: Oracle Linux RHCKの既知の問題については、RHEL 6.10のを参照してくださいlink:hu_rhel_610.html#known-problems-and-limitations["既知の問題"]。
