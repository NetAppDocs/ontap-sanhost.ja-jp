...
次のセクションでは、ASA構成およびASA以外の構成にマッピングされたLUNのマルチパス出力の例を示します。
...
NOTE: Oracle Linux 9.1 Red Hat Enterprise Kernel（RHCK）を設定するには、link:hu_rhel_91.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）9.1を使用します。
