...
NOTE: Oracle Linux 7.7 Red Hat Enterprise Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）7.7を使用しlink:hu_rhel_77.html#recommended-settings["推奨設定"]ます。
