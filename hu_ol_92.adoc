...
NOTE: Oracle Linux 9.2 Red Hat Enterprise Kernel（RHCK）を設定するには、link:hu_rhel_91.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）9.2を使用します。
