...
NOTE: Oracle Linux 9.2 RedHat Enterprise Kernel（RHCK）を設定するには、を使用します link:hu_rhel_91.html#recommended-settings["推奨設定"] Red Hat Enterprise Linux（RHEL）9.2の場合。
