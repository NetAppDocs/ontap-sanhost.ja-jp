...
NOTE: Oracle Linux 9.2 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）9.2を使用しlink:hu_rhel_92.html#recommended-settings["推奨設定"]ます。
