...
NOTE: Oracle Linux 8.1 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）8.1を使用しlink:hu_rhel_81.html#recommended-settings["推奨設定"]ます。
...
NOTE: Oracle Linux RHCKの既知の問題については、RHEL 8.1のを参照してくださいlink:hu_rhel_81.html#known-problems-and-limitations["既知の問題"]。
