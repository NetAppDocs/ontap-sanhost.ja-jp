...
NOTE: Oracle Linux 8.1 Red Hat Enterprise Kernel（RHCK）を設定するには、link:hu_rhel_81.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）8.1を使用します。
