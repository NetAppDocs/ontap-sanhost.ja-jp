...
---
= NetApp ONTAP で Oracle Linux 6.7 を使用する
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Oracle Linux 6.7 Red Hat Enterprise Kernel （ RHCK ）を設定するには、を使用します link:hu_rhel_67.html#recommended-settings["推奨設定"] Red Hat Enterprise Linux （ RHEL ） 6.7 の場合



== 既知の問題および制限

Oracle 6.7 には既知の問題はありません。
