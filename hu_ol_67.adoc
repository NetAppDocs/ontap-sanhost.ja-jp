...
NOTE: Oracle Linux 6.7 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）6.7を使用しlink:hu_rhel_67.html#recommended-settings["推奨設定"]ます。
...
NOTE: Oracle Linux RHCKの既知の問題については、RHEL 6.7の『』を参照してlink:hu_rhel_67.html#known-problems-and-limitations["既知の問題"]ください。
