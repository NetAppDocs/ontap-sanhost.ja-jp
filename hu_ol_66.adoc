...
NOTE: Oracle Linux 6.6 Red Hat Compatible Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）6.6を使用しますlink:hu_rhel_66.html#recommended-settings["推奨設定"]。
...
NOTE: Oracle Linux RHCKの既知の問題については、（RHEL 6.6）を参照してくださいlink:hu_rhel_66.html#known-problems-and-limitations["既知の問題"]。
