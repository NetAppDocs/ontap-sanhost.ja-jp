...
VVOLのプロビジョニングと管理の詳細については、ONTAP Tools for VMware vSphereのドキュメント、 https://docs.netapp.com/us-en/netapp-solutions/virtualization/vsphere_ontap_ontap_for_vsphere.html["TR-4597"^]およびlink:https://www.netapp.com/pdf.html?item=/media/13555-tr4400pdf.pdf["TR-4400"^]
