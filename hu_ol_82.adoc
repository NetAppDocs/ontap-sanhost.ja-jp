...
NOTE: Oracle Linux 8.2 RedHat Enterprise Kernel （ RHCK ）を設定するには、を使用してください link:hu_rhel_82.html#recommended-settings["推奨設定"] Red Hat Enterprise Linux （ RHEL ） 8.2 の場合：



== 既知の問題

ONTAPリリースのOracle Linux 8.2に関する既知の問題はありません。


NOTE: Oracle Linux （ Red Hat 互換カーネル）の既知の問題については、を参照してください link:hu_rhel_82.html#known-problems-and-limitations["既知の問題"] Red Hat Enterprise Linux （ RHEL ） 8.2 の場合：
