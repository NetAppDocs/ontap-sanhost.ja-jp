...
NOTE: Oracle Linux 8.2 Red Hat Enterprise Kernel（RHCK）を設定するには、link:hu_rhel_82.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）8.2を使用します。
