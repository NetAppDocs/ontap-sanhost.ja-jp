...
summary: Oracle Linux 10ホストにLinux Host Utilitiesをインストールして、ONTAP LUNを使用したFCPおよびiSCSIプロトコル処理を管理します。 
---
= ONTAPストレージを使用したFCPおよびiSCSI用のOracle Linux 10の設定
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Linux Host Utilitiesソフトウェアは、ONTAPストレージに接続されているLinuxホストの管理および診断ツールを提供します。Oracle Linux 10ホストにLinux Host Utilitiesをインストールすると、Host Utilitiesを使用してONTAP LUNでFCPおよびiSCSIプロトコル操作を管理できます。
...
Oracle Linux 10でマルチパスを使用してONTAP LUNを管理できます。
