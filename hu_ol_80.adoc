...
NOTE: Oracle Linux 8.0 Red Hat Enterprise Kernel（RHCK）を設定するには、link:hu_rhel_80.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）8.0を使用します。
