...
NOTE: Oracle Linux 7.8 Red Hat Enterprise Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）7.8を使用しlink:hu_rhel_78.html#recommended-settings["推奨設定"]ます。
