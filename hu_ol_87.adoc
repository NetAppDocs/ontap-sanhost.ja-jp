...
NOTE: Oracle Linux 8.7 Red Hat Enterprise Kernel（RHCK）を設定するには、link:hu_rhel_87.html#recommended-settings["推奨設定"]for Red Hat Enterprise Linux（RHEL）8.7を使用します。
...
ONTAPリリースのOracle Linux 8.7に関する既知の問題はありません。
