...
NOTE: Oracle Linux 8.7 Red Hat Enterprise Kernel（RHCK）を設定するには、for Red Hat Enterprise Linux（RHEL）8.7を使用しlink:hu_rhel_87.html#recommended-settings["推奨設定"]ます。
...
ONTAPリリースのOracle Linux 8.7では、既知の問題はありません。
