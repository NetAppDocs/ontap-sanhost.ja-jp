...
summary: Citrix Hypervisor 8.4 をマルチパス用に構成し、 ONTAPストレージでの FCP および iSCSI プロトコル操作用の特定のパラメーターと設定を設定します。 
---
...
[role="lead"]
Citrix Hypervisor 8.4 をマルチパス用に構成し、 ONTAPストレージでの FCP および iSCSI プロトコル操作用の特定のパラメーターと設定を設定します。
...
Citrix Hypervisor 8.4 のマルチパスを使用して、 ONTAP LUN を管理できます。
